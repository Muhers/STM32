...
/*---------------------------------------------------------------------------------------------*/
	...
	TIM_TimeBaseStructure.TIM_Period = 0xffffffff - 1;//重装载值 32位
...
/*---------------------------------------------------------------------------------------------*/	
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority= OS_THREAD_3; //抢占优先级  
	NVIC_InitStructure.NVIC_IRQChannelSubPriority= 0 ; //响应优先级   
	NVIC_InitStructure.NVIC_IRQChannelCmd=ENABLE;
	NVIC_Init(&NVIC_InitStructure);// 初始化 NVIC_
...
/*---------------------------------------------------------------------------------------------*/	
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority= OS_THREAD_9 ; //抢占优先级 3
	NVIC_InitStructure.NVIC_IRQChannelSubPriority= 0 ; //响应优先级  
	NVIC_InitStructure.NVIC_IRQChannelCmd=ENABLE;
	NVIC_Init(&NVIC_InitStructure);// 初始化 NVIC_
