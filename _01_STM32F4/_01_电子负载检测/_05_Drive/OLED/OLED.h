...
#define OLED_CS_Set1() GPIO_SetBits(GPIOD,GPIO_Pin_1)    //接OLED模块CS1

#define OLED_DC_Clr1() GPIO_ResetBits(GPIOD,GPIO_Pin_0)
#define OLED_DC_Set1() GPIO_SetBits(GPIOD,GPIO_Pin_0)     //接OLED模块D/C

#define OLED_SDA_Clr1() GPIO_ResetBits(GPIOD,GPIO_Pin_15)
#define OLED_SDA_Set1() GPIO_SetBits(GPIOD,GPIO_Pin_15)    //接OLED模块SDI

#define OLED_SCL_Clr1() GPIO_ResetBits(GPIOD,GPIO_Pin_14)
#define OLED_SCL_Set1() GPIO_SetBits(GPIOD,GPIO_Pin_14)    //接OLED模块的CLK




#define OLED_CS_Clr2() GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define OLED_CS_Set2() GPIO_SetBits(GPIOB,GPIO_Pin_12)    //接OLED模块CS1

#define OLED_DC_Clr2() GPIO_ResetBits(GPIOB,GPIO_Pin_13)
#define OLED_DC_Set2() GPIO_SetBits(GPIOB,GPIO_Pin_13)     //接OLED模块D/C

#define OLED_SDA_Clr2() GPIO_ResetBits(GPIOE,GPIO_Pin_10)
#define OLED_SDA_Set2() GPIO_SetBits(GPIOE,GPIO_Pin_10)    //接OLED模块SDI

#define OLED_SCL_Clr2() GPIO_ResetBits(GPIOE,GPIO_Pin_9)
#define OLED_SCL_Set2() GPIO_SetBits(GPIOE,GPIO_Pin_9)    //接OLED模块的CLK
