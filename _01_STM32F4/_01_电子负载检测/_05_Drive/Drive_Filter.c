...
{ 
	while(_phase > 360.0f || _phase < -360.0f)
	{
		if(_phase > 360.0f) _phase -= 360.0f;
		else if(_phase < -360.0f) _phase += 360.0f;
	} 
	
	if(_phase > 180.0f) _phase = _phase - 360.0f;
	else if(_phase < -180.0f) _phase = _phase + 360.0f;
